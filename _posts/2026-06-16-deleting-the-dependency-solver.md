...
<figure>
  ...
  <figcaption>cabal searches for a version assignment; zinc pins a commit and freezes it.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/hero-four-walls.svg" alt="An aqua line labelled build network punches left to right through four walls labelled include-dirs, configure sdist, preproc scope, and MIN_VERSION, ending at the word linked.">
  <figcaption>Four layers of plumbing cabal hides, each only visible once you clear the one before it.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/hero-wasm-envelope.svg" alt="A rounded boundary labelled wasm32-wasi envelope contains ticked items pure Haskell and in-package C sources. Outside, a zlib token bounces off the boundary with the label ZINC_WASM_UNSUPPORTED, fail-fast. Dashed arrows show the boundary expanding over time.">
  <figcaption>Inside the envelope it builds; an external system library fails fast and named.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>zinc builds zinc — the definition of done.</figcaption>
</figure>
